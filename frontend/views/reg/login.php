    	...
    	<input type="hidden" id="resubmitToken" value="" />		
		 <div class="login_box">
		 	<?php $form=ActiveForm::begin(array('id'=>'loginForm'));?>
		 		<?php echo $form->field($model,'username')->textInput(array('id'=>'email','name'=>'username','placeholder'=>'请输入登录用户名'));?>
		 		<?=$form->field($model,'password')->textInput(array('id'=>'password','name'=>'password','tabindex'=>'2','placeholder'=>'请输入密码','type'=>'password'))?>
