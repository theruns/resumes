...
<body id="login_bg">
	<div class="login_wrapper">
		...
		<div class="login_box">
		        ...
		        <?php echo $form->field($model,'username')->textInput(array('id'=>'email','name'=>'username','placeholder'=>'请输入用户名'));?>
                <span class="error" style="display:none;" id="beError"></span>
                <?php echo $form->field($model,'password')->passwordInput(array('id'=>'password','name'=>'password','placeholder'=>'请输入密码'));?>
            <!--     <input type="password" id="password" name="password" tabindex="2" placeholder="请输入密码" /> -->
                ...
                <!-- <a style="color:#fff;" href="javascript:void" class="submitLogin" title="注 &nbsp; &nbsp; 册"/>注 &nbsp; &nbsp; 册</a>  -->
